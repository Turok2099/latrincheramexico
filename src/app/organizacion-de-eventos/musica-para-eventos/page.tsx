...
export default function MusicaParaEventosPage() {
  const heroImage = cloudinaryImages["musica-para-eventos"][0];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <HeroSection
        ...
        subtitle="El sonido perfecto para crear la atmósfera ideal"
