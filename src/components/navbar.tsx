            ...
            <div className="pb-8 mt-12">
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  placeholder="Buscar"
                  className="w-full bg-white/10 border-2 border-white/20 rounded-xl pl-5 pr-14 py-4 text-base text-white placeholder-white/50 focus:outline-none focus:border-[#22d3f7] focus:bg-white/15 transition-all duration-300"
                />
                <button
                  type="submit"
                  className="absolute right-3 top-1/2 -translate-y-1/2 p-2.5 text-[#22d3f7] hover:text-white transition-colors duration-300"
                  aria-label="Buscar"
                >
                  <svg
                    className="w-6 h-6"
