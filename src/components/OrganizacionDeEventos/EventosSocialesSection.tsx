        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              En nuestra empresa organizadora de eventos en CDMX, transformamos
              cada idea en una experiencia inolvidable. Nos especializamos en la
              organización de eventos sociales, desde bodas y cumpleaños hasta
              celebraciones temáticas, cuidando cada detalle para que tú solo te
